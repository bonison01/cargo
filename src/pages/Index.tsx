    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="relative py-20 overflow-hidden">
          ...
          <div 
            className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')]"
            style={{ opacity: 0.6 }}
          />
          <div className="container relative">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6 animate-fade-in">
                Streamlined Shipping & Invoice Management
              </h1>
        ...
        <section className="py-16 container">
          ...
          <div className="grid gap-8 md:grid-cols-3 animate-fade-in" style={{ animationDelay: "300ms" }}>
            {features.map((feature, index) => (
              <Card key={index} className="glass h-full border transition-all duration-300 hover:shadow-md hover:border-primary/20">
                <CardHeader>
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-4 md:mb-0">
              ...
              <span className="font-semibold text-lg">TrackShip</span>
            </div>
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} TrackShip. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
